...
export const getHvacAssets = (hospitalId: string) => 
  hospitalId === 'bekasi' ? hvacAssetsBekasi : hvacAssetsCipadung;
...
export const getWaterTanks = (hospitalId: string) => 
  hospitalId === 'bekasi' ? waterTanksBekasi : waterTanksCipadung;
...
export const getWaterPumps = (hospitalId: string) => 
  hospitalId === 'bekasi' ? waterPumpsBekasi : waterPumpsCipadung;
